...
public class VariableExample {
	...
	public static void main(String[] args) {
		/*
	     ...
	     3. 변수는 동일한 이름으로 중복 선언할 수 없습니다. 구분x
		...
		//int count = "한번"; (x)	 정수 아닌 문자
		//int count = 23.5; (x)  정수 아닌 실수
		//String str = 100; (x) 문자 아닌 정수(숫자)
