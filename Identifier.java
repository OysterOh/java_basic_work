...
//		int age = 40; (x)
		...
		//2. 식별자 이름은 숫자로 지정하거나 숫자로 시작하면 안됩니다. 이름이 아닌 값으로 식별
//		int 700 = 365; (x)
//		int 7number = 7; (x)
		int number7 = 7;
		int num7ber = 7;
...
//		int my birthday = 20001109; (x)
		int mybirthday = 20001109;
		int myBirthDay = 20001109;  //camel case
